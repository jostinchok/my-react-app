...
const styles = StyleSheet.create({
  ...
  uploadSection: { backgroundColor: '#fffdf4', padding: 20, borderRadius: 18, borderWidth: 1, borderColor: '#eadfbd' },
  sectionTitle: { fontSize: 20, fontWeight: '800', color: '#1f2f28', marginBottom: 16 },
  uploadForm: { gap: 16 },
  pickerContainer: { borderWidth: 1, borderColor: '#eadfbd', borderRadius: 14, padding: 12, backgroundColor: '#fff8e6' },
  pickerLabel: { fontWeight: '700', color: '#5f726a', marginBottom: 8 },
  picker: { height: 44 },
  uploadBtn: { backgroundColor: '#ffd23f', padding: 16, borderRadius: 14, alignItems: 'center' },
  uploadBtnText: { color: '#102419', fontWeight: '900', fontSize: 16 },
  ...
  downloadBtn: { backgroundColor: '#0b3b28', padding: 12, borderRadius: 12, alignItems: 'center' },
  downloadBtnText: { color: '#fff8e6', fontWeight: '800' },
